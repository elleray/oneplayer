package xy.media.oneplayer.view;
...
public class ShapedImageView extends ImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mStrokeWidth = a.getDimension(R.styleable.ShapedImageView_shape_image_stroke_width, 0);
            mStrokeColor = a.getColor(R.styleable.ShapedImageView_shape_image_stroke_color, mStrokeColor);
            a.recycle();
        }
